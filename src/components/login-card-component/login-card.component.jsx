...
import LoginCardContent from "../login-card-content/login-card-content.component";
import { CardContainer, LogoContainer } from "./login-card-styles";
  ...
  return (
    <CardContainer>
      <LogoContainer>
        ...
        <svg style={{ color: "#4d61fc" }} width="35px" viewBox="0 0 294 294">
